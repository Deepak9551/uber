package com.spring.took.api.Uber.AsceptWork;
...
public class Ascept {
    ...
    @Pointcut("execution(* com.spring.took.api.Uber.TodoApp.getTodos() )")
...
//        System.out.println("Gaya : "+System.currentTimeMillis());
    ...
    @Before("execution(* com.spring.took.api.Uber.TodoApp.addTodo(..))")
    public void BeforeWork(){
        System.out.println("Call");
    }

    @AfterReturning(value = "execution(* com.spring.took.api.Uber.TodoApp.getTodo(..))" ,returning = "result")
